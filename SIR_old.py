...
def Simulate_SIR(contact_network,social_network,T,beta,gamma,mu,init,
                 q=False,save_all=False,lt_threshold=None,adherence=None,begin_q=0,seeds=None,initial_state_dict=None):
    if begin_q is None:
        begin_q = 0
    ...
    elif isinstance(adherence, list):
        adhering = set(adherence)
